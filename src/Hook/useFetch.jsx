...
const createApiInstance = (baseURL = process.env.REACT_APP_API_URL || 'http://localhost:3001/api') => {
...
export const useApi = (endpoint, options = {}) => {
  ...
  // GET - Fetch data
  const get = useCallback(async (id = '', params = {}) => {
  ...
  const post = useCallback(async (payload, customEndpoint = '') => {
  ...
  const customRequest = useCallback(async (config) => {
